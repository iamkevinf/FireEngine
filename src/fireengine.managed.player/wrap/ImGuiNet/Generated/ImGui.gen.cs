...
namespace ImGuiNET
{
    public static unsafe partial class ImGui
    {
        ...
        {
            Vector2 ret;
            ImGuiNative.igGetCursorPos(&ret);
            return ret;
        }
        ...
        {
            Vector2 ret;
            ImGuiNative.igGetCursorScreenPos(&ret);
            return ret;
        }
        public static Vector2 GetCursorStartPos()
        {
            Vector2 ret;
            ImGuiNative.igGetCursorStartPos(&ret);
            return ret;
        }
        ...
        {
            Vector2 pOut;
            ImGuiNative.igGetItemRectMax(&pOut);
            return pOut;
        }
        public static Vector2 GetItemRectMin()
        {
            Vector2 pOut;
            ImGuiNative.igGetItemRectMin(&pOut);
            return pOut;
        }
        ...
        {
            Vector2 ret;
            ImGuiNative.igGetWindowPos(&ret);
            return ret;
        }
        public static Vector2 GetWindowSize()
        {
            Vector2 ret;
            ImGuiNative.igGetWindowSize(&ret);
            return ret;
        }
