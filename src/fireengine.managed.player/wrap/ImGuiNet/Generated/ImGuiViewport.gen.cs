...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImGuiViewportPtr
    {
        ...
        public Vector2 GetCenter() { return Pos + Size * 0.5f; }
        public Vector2 GetWorkPos() { return Pos + WorkOffsetMin; }
        public Vector2 GetWorkSize() { return Size - WorkOffsetMin; } // This not clampe
        public void Destroy()
        {
